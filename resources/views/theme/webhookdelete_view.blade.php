...
<div class="content">
  ...
  <form method="post" action="{{secure_asset('/webhookdelete')}}">
  @csrf
   <label>Please Enter Webhook ID : </label>
   <input type="text" name="webhookid" />
   <input type="submit" name="sbmitbtn" value="Delete Webhook" />
  </form>
