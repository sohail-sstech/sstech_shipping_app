                ...
                <div class="container">
                    <div class="row">
				        <div class="col-md-12 top-campaign">
						    ...
						    <div class="row">
							  <div class="col-md-10">
								<h3 class="title-5 m-b-35">Labels</h3>
							  </div>
							</div>
							<div class="card">
                                    <div class="card-header">
                                        <strong>Search</strong> Label
                                    </div>
                                    <div class="card-body card-block">
                                        <form  name="lbldetails_filter_data" class="" id="lbldetails_filter_data" >
                                          <div class="row form-group">
												...
												<div class="col-sm-3">
													<label for="is_manifest" class="col-form-label">Manifested</label>
												...
												<div class="col-sm-3">
												<button type="button" onclick="reload_table('lbldetailsgrid_dt')" class="btn btn-success btn-bg" style="margin-top:40px;">
                                ...
                                <table class="table table-data2" id="lbldetailsgrid_dt" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
											...
											<th class="card-header" style="min-width: 50px">Manifested</th>
